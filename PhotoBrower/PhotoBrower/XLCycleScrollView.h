...
- (void)currentScrollPage:(NSInteger)index;
- (void)didClickPage:(XLCycleScrollView *)csView atIndex:(NSInteger)index;
- (void)CycScrollViewDidScroll:(XLCycleScrollView *)csView andCurrentIndex:(NSInteger)index;
- (void)CycScrollViewBeginScroll:(XLCycleScrollView *)csView andCurrentIndex:(NSInteger)index;
